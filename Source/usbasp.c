...
#define FUNC_SET_ISP_SPEED			34
#define FUNC_GET_ISP_SPEED			35
#define FUNC_GET_VOLTAGE			36
...
uchar usbFunctionSetup(uchar data[8])
{
  ...
  else if(data[1] == FUNC_GET_ISP_SPEED)
    {
	  replyBuffer[0] = ISP_Speed;
	  len = 1;
	}
  else if(data[1] == FUNC_GET_ISP_SPEED)
    {
  ...
  else if(data[1] == FUNC_GET_VOLTAGE)
    {
	  replyBuffer[0] = ISP_getsupplyvoltage();
	  len = 1;
	}
